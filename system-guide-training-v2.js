...
const flowV3={
  ...
  intake:[
    {id:'application',no:'01',title:'Application Submitted',owner:'Student + System',module:'Applications',trigger:'Student submits online Admission Form',action:'Capture applicant data and the four compulsory uploads: IC / Passport, Academic Transcript, Academic Certificate and CV / Resume. System creates the Reference No, student folder, Admission Form PDF and workflow record.',output:'Controlled application record',next:'Issue submission COL + welcome email',moduleKey:'applications'},
    {id:'submission-col',no:'01A',title:'COL + Welcome Email',owner:'System / IPGS Admission',module:'Applications',trigger:'Valid Admission Form submission completed',action:'Generate one Conditional Offer Letter, save it in the student folder and email the student a welcoming message with the COL and Admission Form attached.',output:'Submission COL issued + student welcomed',next:'Admission review continues; Prospect task proceeds separately',moduleKey:'applications'},
  ...
  admission:[
    ...
    {id:'ia',no:'05A',title:'Internal Assessment',owner:'Registry / Academic',module:'IA / PREREQ',trigger:'SAC result = Internal Assessment',action:'Send the IA email / related attachment, then run and record the approved IA process and outcome. No new COL is issued.',output:'IA sufficient OR prerequisite required',next:'Offer route or PREREQ',moduleKey:'assessment'},
    {id:'prereq',no:'05B',title:'Prerequisite Course',owner:'Registry / Academic',module:'IA / PREREQ',trigger:'Authorised IA outcome requires prerequisite',action:'Send the prerequisite email / related attachment, then enrol, monitor and complete the approved prerequisite subjects. No new COL is issued; PREREQ is never selected directly as the SAC result.',output:'Prerequisite completion evidence',next:'Return to Offer eligibility',moduleKey:'assessment'},
...
function renderFlowV3(){
  ...
  return '<div class="g3-map">'+
    ...
    '<section class="g3-stage-block intake">'+
      ...
      '<div class="g3-entry">'+
        '<div class="g3-linear short" style="border-top:0;margin-top:0">'+flowV3Card(i[0],'hero-node')+flowV3Arrow()+flowV3Card(i[1],'success-node')+'</div>'+
        '<div class="g3-split"><span></span><b>After the COL is issued, admission review and SKY Prospect operations can continue on their own controlled tracks</b><span></span></div>'+
        '<div class="g3-entry-branches">'+
          '<div class="g3-branch-card"><label>ADMISSION REVIEW TRACK</label><div class="g3-branch-start">Registry begins Document Review and Qualification Screening. The submission COL does not replace SAC / IA / prerequisite / final Official Offer requirements.</div></div>'+
          '<div class="g3-branch-card prospect"><label>SKY PROSPECT TRACK</label>'+flowV3Card(i[2],'compact')+'<div class="g3-branch-note">This track is recorded in Prospect / Activation and does not replace the admission decision process.</div></div>'+
        '</div>'+
      '</div>'+
    '</section>'+
