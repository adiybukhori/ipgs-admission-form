...
function handleV2Post_(payload) {
  ...
  if (action === 'v2PrepareAcceptancePack') return v2AcceptancePackEnsureReviewDocs_((payload.data || {}).referenceNo, payload.updatedBy || 'Admin Portal V2');
  ...
  if (action === 'v2SendMissingDocumentRequest') return v2SendMissingDocumentRequest_(payload.data || {}, payload.updatedBy || 'Student Concierge Agent');
  ...
  if (action === 'v2RemoveOrientationStudent') return v2RemoveOrientationStudent_(payload.data || {}, payload.updatedBy || 'Admin Portal V2');
  if (action === 'v2MoveOrientationStudent') return v2MoveOrientationStudent_(payload.data || {}, payload.updatedBy || 'Admin Portal V2');
